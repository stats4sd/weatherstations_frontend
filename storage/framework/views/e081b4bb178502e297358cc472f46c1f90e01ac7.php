                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="weatherstation" class="form-control btn btn-outline-info">
                                        ...
                                        <option id='<?php echo e($station->id); ?>' value='<?php echo e($station->id); ?>'><?php echo e($station->label); ?></option>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forge/weatherstations.stats4sd.org/resources/views/admin.blade.php ENDPATH**/ ?>