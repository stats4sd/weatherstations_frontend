	...
	if(typeof getDownload != 'function') {
		 ...
		 */
      	function getDownload(e) {
			...
			$.ajax({
				"url": "<?php echo e(url($crud->route . '/download')); ?>",
				"method":"POST",
...
<?php /**PATH /home/forge/weatherstations.stats4sd.org/resources/views/vendor/backpack/crud/buttons/download.blade.php ENDPATH**/ ?>