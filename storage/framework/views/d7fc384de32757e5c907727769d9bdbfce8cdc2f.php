                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <label for="station" ><b>Select station</b></label>
                                        ...
                                        <select class="form-control" id="station" style="width:200px;">
                                            ...
                                            <option class = "active" value=<?php echo e($station->id); ?>><?php echo e($station->label); ?></option>
                                ...
                                <div class="col-sm">
                                    ...
                                    <select class="form-control" id="year" style="width:200px;">
                                        ...
                                        <option value=<?php echo e($year->fecha); ?>><?php echo e($year->fecha); ?></option>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forge/weatherstations.stats4sd.org/resources/views/dashboard.blade.php ENDPATH**/ ?>