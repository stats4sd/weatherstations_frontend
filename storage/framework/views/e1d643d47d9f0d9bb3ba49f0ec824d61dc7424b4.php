    ...
    <?php $__currentLoopData = $qrcodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qrcode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="page justify-content-center p-4">
            ...
            <div class="card w-75 ml-auto mr-auto mb-4">
                    <?php echo $__env->make('qr_label', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</style><?php /**PATH /home/forge/weatherstations.stats4sd.org/resources/views/qr-print.blade.php ENDPATH**/ ?>