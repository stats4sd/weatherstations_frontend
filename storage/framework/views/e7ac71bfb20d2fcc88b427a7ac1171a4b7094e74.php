		...
		<div class="form-group backpack-filter mb-0">
			<div class="input-group date">
		        ...
		        <input class="form-control pull-right"
		        		id="datepicker-<?php echo e($filter->key); ?>"
		        		type="text"
						<?php if($filter->currentValue): ?>
							value="<?php echo e($filter->currentValue); ?>"
						<?php endif; ?>
		        		>
		        <div class="input-group-append datepicker-<?php echo e($filter->key); ?>-clear-button">
...
<?php $__env->startPush('crud_list_scripts'); ?>
  ...
  <script>
		jQuery(document).ready(function($) {
			var dateInput = $('#datepicker-<?php echo e($filter->key); ?>').datepicker({
				autoclose: true,
				format: 'yyyy-mm-dd',
				todayHighlight: true
			})
			...
			$('li[filter-key=<?php echo e($filter->key); ?>]').on('filter:clear', function(e) {
				...
				$('#datepicker-<?php echo e($filter->key); ?>').datepicker('update', '');
				$('#datepicker-<?php echo e($filter->key); ?>').trigger('changeDate');
			});

			// datepicker clear button
			$(".datepicker-<?php echo e($filter->key); ?>-clear-button").click(function(e) {
				e.preventDefault();
...
<?php /**PATH /home/forge/weatherstations.stats4sd.org/vendor/backpack/crud/src/resources/views/crud/filters/date.blade.php ENDPATH**/ ?>