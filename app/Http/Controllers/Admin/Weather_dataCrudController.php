...
use App\Http\Requests\Weather_dataRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Symfony\Component\Process\Exception\ProcessFailedException;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class Weather_dataCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class Weather_dataCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Weather_data::class);
    ...
    {
        CRUD::setValidation(Weather_dataRequest::class);
