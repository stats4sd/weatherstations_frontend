...
INSERT INTO `staging_weatherstations` (`fecha_hora`, `hardware_id`,`temperatura_externa`, `humedad_externa`, `punto_rocio`,`temperatura_interna`, `humedad_interna`, `index_heat`, `presion_relativa`, `velocidad_viento`, `wind_chill`, `lluvia_hora`, `lluvia_total`,`uv_index`, `solar_rad`, `evapotran`) 
